...
@section("content")
    ...
    <form class="form-horizontal" method="post" enctype="multipart/form-data" action="">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control"  placeholder="活动名称" name="title" value="{{old("title",$activity->title)}}">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="datetime-local"  class="form-control" placeholder="活动结束时间" name="start_time" value="{{$activity->start_time}}">
            </div>
        </div>
